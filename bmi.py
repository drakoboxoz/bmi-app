...
if bmi<18.5:
    ...
    s.image("C:/Users/Captain/Pictures/Screenshots/skinny.png.png")
elif bmi<23:
    s.info(f"{bmi}")
    s.info("healthy")
    s.success("keep up")
    s.image("C:/Users/Captain/Pictures/Screenshots/normal.png")
elif bmi<25:
    s.info(f"{bmi}")
    s.info("overweight")
    s.warning("diet please?")
    s.image("C:/Users/Captain/Pictures/Screenshots/chubby.png")
elif bmi<30:
    s.info(f"{bmi}")
    s.info("fat")
    s.error("you make a sumo wrestler look like a supermodel")
    s.image("C:/Users/Captain/Pictures/Screenshots/brainrot.png")
else:
    s.info(f"{bmi}")
    ...
    s.image("C:/Users/Captain/Pictures/Screenshots/caseoh.png")
